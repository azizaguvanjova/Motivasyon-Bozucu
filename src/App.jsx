...
export default function App() {
  ...
  /* getSmallestFontSize fonksiyonu nasıl kullanılır:
        ...
        Font size ile ilgili veriler string olarak saklanır: örneğin, "30px" ve "20px". Bu tür verilere sahip iki nesneyi bu fonksiyona 
        argüman olarak girerseniz, fonksiyon en küçük yazı tipine sahip nesneyi döndürür. Fonksiyon, değerlerden birinin ya da her ikisinin
        de undefined olmasıyla ilgilenmez. Bu durumlardan herhangi birini işleyebilir Örneğin:
...
*/
  ...
  /* Challenge 
    ...
    Geçerli resim ve metin çifti için stiller currentData state'i içinde bulunur, ancak bunlar ilgili JSX öğelerine uygulanmaz.
     Göreviniz bunu aşağıdaki gibi düzeltmektir:
      ...
      3. Ya image.quoteFontSize ya da text.quoteFontSize hangisi ( varsa) içeriyorsa  en küçük font boyutu, className'i "quote" olan 
      <p>'ye uygulanmalıdır. Bunu yapmak için, bu dosyanın 60. satırındaki getSmallestFontSize() fonksiyonunu kullanabilirsiniz.
       Nasıl kullanılacağı hakkında bilgi için fonksiyonun üzerindeki yoruma bakın. 
        
     İpucu: currentData state'ini görmek ve içeriğine ve yapısına alışmak için bu bileşenin üst seviyesinde herhangi bir yerde 
     showState(currentData) komutunu çağırın. 
*/
